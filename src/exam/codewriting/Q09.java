...
public class Q09 {
	...
	public static void main ( String[] args ) {
		...
		System.out.println(numDigits(1000123567));//should be 10
		System.out.println(numDigits(1));//should be 1
		System.out.println(numDigits(0));//should be 1
	}
